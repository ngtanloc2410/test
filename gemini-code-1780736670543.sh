...
# Chạy ngầm toàn bộ tiến trình để không làm treo quá trình Boot của máy ảo
(
    # Ghi lại toàn bộ log cài đặt vào file này để dễ dàng kiểm tra nếu có lỗi
    exec > /var/log/traffmonetizer_autodeploy.log 2>&1
    
    echo "=========================================="
    echo "BẮT ĐẦU TIẾN TRÌNH CLOUD-INIT"
    echo "=========================================="
...
EOF
    ...
    echo ">> Đang chạy Container Traffmonetizer..."
